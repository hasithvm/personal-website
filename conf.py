...
BLOG_AUTHOR = "Hasith Vidanamadura"  # (translatable)
BLOG_TITLE = "/dev/shm/"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://hasith.vidanamadura.net/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://hasith.vidanamadura.net/"
BLOG_EMAIL = "hasith@vidanamadura.net"
BLOG_DESCRIPTION = "tech, projects, and hobbies"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/rss.xml", "RSS", "fa-solid fa-square-rss"),
    ),
}
...
THEME_CONFIG = {
    DEFAULT_LANG: {
        ...
        'sidebar': 
        {
            'Github': {"iconClass" : 'fa-brands fa-github', "url": "https://github.com/hasithvm/"},
            'LinkedIn': {"iconClass": 'fa-brands fa-linkedin', 'url' : "https://www.linkedin.com/in/hasith-vidanamadura-b0a65236/"},
            'Instagram': {"iconClass": 'fa-brands fa-instagram', 'url' : "https://www.instagram.com/hasithvm2"},
...
POSTS = (
    ("posts/*.rst", "projects", "post.tmpl"),
    ("posts/*.md", "projects", "post.tmpl"),
    ("posts/*.txt", "projects", "post.tmpl"),
    ("posts/*.html", "projects", "post.tmpl"),
)
PAGES = (
    ("pages/*.rst", "", "page.tmpl"),
    ("pages/*.md", "", "page.tmpl"),
...
# (translatable)
CONTENT_FOOTER = """
Contents &copy; {date} by {author}. Last generated {build_time}{current_hash}. 
...
CONTENT_FOOTER_FORMATS = {
    DEFAULT_LANG: (
        (),
        {
            ...
            "license": LICENSE,
            "build_time": time.strftime("%a, %d %b %Y %H:%M:%S UTC", time.gmtime()),
            "current_hash": commitHashHelper(),
        }
    )
}
...
APPINSIGHTS_KEY=os.getenv("APPINSIGHTS_KEY", "InstrumentationKey=e95acf8e-5e02-46e8-afdf-5d451ff6d61c;IngestionEndpoint=https://westus2-2.in.applicationinsights.azure.com/;LiveEndpoint=https://westus2.livediagnostics.monitor.azure.com/quickpulseservice.svc")
